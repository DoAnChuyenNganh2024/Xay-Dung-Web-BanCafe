...
const Authors = () => {
  return (
    <Box>
      ...
      <Category imgURL={"/static/images/logo.jpg"}>Nguyen Minh Huy</Category>
      <Category imgURL={"/static/images/logo.jpg"}>Nguyen Duc Thuan</Category>
      <Category imgURL={"/static/images/logo.jpg"}>Vi Van Khanh</Category>
      <Category imgURL={"/static/images/logo.jpg"}>Pham Minh Quan</Category>
      <Category imgURL={"/static/images/logo.jpg"}>Vu Van Son</Category>
    </Box>
  );
};
